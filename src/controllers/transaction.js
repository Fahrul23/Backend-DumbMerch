...
const midtransClien = require("midtrans-client")
...
exports.addTransaction = async (req, res) => {
  try {
    ...
    let snap = new midtransClien.Snap({
        // set to true if you want Production Environtment
        isProduction: false,
...
const core = new midtransClien.CoreApi()
core.apiConfig.set({
    isProduction: false,
...
const updateProduct = async (orderId) => {
    ...
    await product.update({qty}, {where: {
        id: productData.id
    }})
}
